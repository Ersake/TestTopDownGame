...
export class PlayerState extends Schema {
    ...
    @type("int32")   damageFlashSeq: number = 0;
    @type("float32") damageFlashDurationMs: number = 0;
    @type("float32") damageFlashBlinkMs: number = 90;
    ...
    @type("int16")   shieldPrimaryAttackSpeedUpgrades: number = 0;
    @type("int16")   shieldPrimaryDamageUpgrades: number = 0;
    @type("int16")   shieldMaxHpUpgrades: number = 0;
    @type("int16")   shieldRechargeUpgrades: number = 0;
    @type("int16")   shieldSizeUpgrades: number = 0;
...
export class EnemyState extends Schema {
    ...
    @type("int16")   health: number = 1;
    @type("int16")   maxHealth: number = 3;
...
export class GameRoomState extends Schema {
    ...
    @type("int8")    gameOverRetryReadyPlayers: number = 0;
    @type("int8")    gameOverRetryTotalPlayers: number = 0;
}
