...
export default {
    ...
    bossCircleExplosion: {
        key: 'boss-circle-explosion',
        frameRate: 18,
        repeat: 0,
        frames: [
            { key: ASSETS.image.bossCircleExplosion1.key },
            { key: ASSETS.image.bossCircleExplosion2.key },
            { key: ASSETS.image.bossCircleExplosion3.key },
            { key: ASSETS.image.bossCircleExplosion4.key },
            { key: ASSETS.image.bossCircleExplosion5.key },
            { key: ASSETS.image.bossCircleExplosion6.key },
            { key: ASSETS.image.bossCircleExplosion7.key },
            { key: ASSETS.image.bossCircleExplosion8.key },
            { key: ASSETS.image.bossCircleExplosion9.key },
            { key: ASSETS.image.bossCircleExplosion10.key },
        ],
    },
    bossBomb: {
        key: 'boss-bomb-fuse',
        texture: ASSETS.spritesheet.bossBomb.key,
        frameRate: 8,
        repeat: -1,
