...
- Wood shield and bone shield are craftable server-owned hotbar items. Wood shield costs 10 wood; bone shield costs 10 bones. Enemy kills add bone stacks directly to the killer's hotbar. Left-click with either shield sends normal attack intent, and the server applies a short-cooldown 1-damage circular bash in front of the player from the cursor aim direction.
